...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if (empty($username) || empty($password))
		...
		$checkIfExists = mysqli_query($conn, "SELECT * FROM rider_profile WHERE username = '".$username."' AND password = '".md5($password)."'");
...
<html>
	...
	<body>
		<form action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" name="rider_login">
